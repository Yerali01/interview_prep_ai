...
import { type AIMessage, getAIResponse, INTERVIEW_SYSTEM_PROMPT } from "@/lib/ai-utils"
...
type SpeechState = "waiting" | "ai-speaking" | "listening" | "processing" | "finished"
...
export default function SpeechInterviewPage() {
  ...
  const processUserAnswer = async (userAnswer: string) => {
    ...
    try {
      ...
      const allMessages = [...messages.filter((m) => m.role !== "system"), contextMessage, userMessage]
      ...
      case "waiting":
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-2">Ready for Speech Interview</h2>
              <p className="text-muted-foreground mb-4">
                Level: <span className="font-semibold capitalize">{level}</span>
              </p>
              <p className="text-sm text-muted-foreground max-w-md mx-auto">
                This is a voice-only interview. The AI will ask questions and you'll speak your answers. Make sure your
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Question {questionCount} of 10</p>
            </div>
          ...
          <div className="text-center space-y-6">
            ...
            {transcript && (
              <div className="max-w-2xl mx-auto p-4 bg-green-50 rounded-lg border-2 border-green-200">
                <p className="text-sm font-medium text-green-800">You're saying:</p>
                <p className="text-green-700">{transcript}</p>
              </div>
            )}
            <div className="flex gap-4 justify-center">
              <Button onClick={handleManualStop} variant="outline" disabled={!transcript.trim()}>
      ...
      case "processing":
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-2">Processing your answer...</h2>
              <p className="text-muted-foreground">Question {questionCount} of 10</p>
            </div>
          </div>
        )
    ...
    return (
      <div className="container py-8">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle className="text-center text-red-600">Speech Not Supported</CardTitle>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p>Your browser doesn't support speech recognition or synthesis.</p>
            <p className="text-sm text-muted-foreground">
              Please use a modern browser like Chrome, Edge, or Safari to use speech interview mode.
            </p>
            <Button onClick={goHome}>
              <Home className="mr-2 h-4 w-4" />
