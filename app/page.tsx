...
export default function Home() {
  ...
  const seniorQuestion = interviewQuestions.find(
    (q) => q.level === "senior" && q.category === "performance"
  );
            ...
            <Card className="max-w-3xl mx-auto">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Category: {seniorQuestion.category}
                </p>
                <p className="text-muted-foreground">
                  Level: {seniorQuestion.level}
                </p>
              </CardContent>
              <CardFooter>
                <Button asChild>
          ...
          {[
            {
              ...
              description:
                "Explore Flutter and Dart topics organized by difficulty level from Junior to Senior",
              link: "/topics",
            },
            {
              ...
              description:
                "Test your knowledge with quizzes that provide detailed explanations for each answer",
              link: "/quiz",
            },
            {
              ...
              description:
                "Track your progress and gradually advance from Junior to Senior level concepts",
              link: "/topics",
            },
            {
            ...
            },
            {
              ...
              description:
                "Access a curated collection of real Flutter interview questions with detailed answers",
              link: "/interview-prep",
            },
            {
              ...
              description:
                "Explore our curated list of external Flutter resources to enhance your knowledge",
              link: "/resources",
            },
          ].map((feature, index) => (
            <div key={index}>
